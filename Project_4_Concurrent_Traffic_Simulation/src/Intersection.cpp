...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    if (_traffic_lights.getCurrentPhase() == TRed)
    {
        _traffic_lights.waitForGreen();
    }
    lck.unlock();
}
...
bool Intersection::trafficLightIsGreen()
{
    ...
    if (_traffic_lights.getCurrentPhase() == TrafficLightPhase::TGreen)
        return true;
    else
        return false;
